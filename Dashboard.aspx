...
<body class="animsition">
    <div class="page-wrapper">
            ...
            <div class="header-mobile__bar">
                <div class="container-fluid">
                    <div class="header-mobile-inner">
                        <a class="logo" href="BootstrapTemplate/index.html">
                            <img src="BootstrapTemplate/images/icon/logo.png" alt="CoolAdmin" />
                        </a>
                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="BootstrapTemplate/index.html">Dashboard 1</a>
                                </li>
                                <li>
                                    <a href="BootstrapTemplate/index2.html">Dashboard 2</a>
                                </li>
                                <li>
                                    <a href="BootstrapTemplate/index3.html">Dashboard 3</a>
                                </li>
                                <li>
                                    <a href="BootstrapTemplate/index4.html">Dashboard 4</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <a href="BootstrapTemplate/chart.html">
                                <i class="fas fa-chart-bar"></i>Charts</a>
                        </li>
                        <li>
                            <a href="BootstrapTemplate/table.html">
                                <i class="fas fa-table"></i>Tables</a>
                        </li>
                        <li>
                            <a href="BootstrapTemplate/form.html">
                                <i class="far fa-check-square"></i>Forms</a>
                        </li>
                        <li>
                            <a href="BootstrapTemplate/calendar.html">
                                <i class="fas fa-calendar-alt"></i>Calendar</a>
                        </li>
                        <li>
                            <a href="BootstrapTemplate/map.html">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="BootstrapTemplate/login.html">Login</a>
                                </li>
                                <li>
                                    <a href="BootstrapTemplate/register.html">Register</a>
                                </li>
                                <li>
                                    <a href="BootstrapTemplate/forget-pass.html">Forget Password</a>
                                </li>
                            </ul>
                        </li>
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="BootstrapTemplate/button.html">Button</a>
                                </li>
                                <li>
                                    <a href="BootstrapTemplate/badge.html">Badges</a>
                                </li>
                                <li>
                                    <a href="BootstrapTemplate/tab.html">Tabs</a>
                                </li>
                                <li>
                                    <a href="BootstrapTemplate/card.html">Cards</a>
                                </li>
                                <li>
                                    <a href="BootstrapTemplate/alert.html">Alerts</a>
                                </li>
                                <li>
                                    <a href="BootstrapTemplate/progress-bar.html">Progress Bars</a>
                                </li>
                                <li>
                                    <a href="BootstrapTemplate/modal.html">Modals</a>
                                </li>
                                <li>
                                    <a href="BootstrapTemplate/switch.html">Switchs</a>
                                </li>
                                <li>
                                    <a href="BootstrapTemplate/grid.html">Grids</a>
                                </li>
                                <li>
                                    <a href="BootstrapTemplate/fontawesome.html">Fontawesome Icon</a>
                                </li>
                                <li>
                                    <a href="BootstrapTemplate/typo.html">Typography</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="#">
                    <img src="BootstrapTemplate/images/icon/logo.png" alt="Cool Admin" />
                </a>
            </div>
                            ...
                            <div class="header-button">
                                        ...
                                        <div class="mess-dropdown js-dropdown">
                                            ...
                                            <div class="mess__item">
                                                <div class="image img-cir img-40">
                                                    <img src="BootstrapTemplate/images/icon/avatar-06.jpg" alt="Michelle Moreno" />
                                                </div>
                                                <div class="content">
                                            ...
                                            <div class="mess__item">
                                                <div class="image img-cir img-40">
                                                    <img src="BootstrapTemplate/images/icon/avatar-04.jpg" alt="Diane Myers" />
                                                </div>
                                                <div class="content">
                                                    <h6>Diane Myers</h6>
                                    ...
                                    <div class="noti__item js-item-menu">
                                        ...
                                        <div class="email-dropdown js-dropdown">
                                            ...
                                            <div class="email__item">
                                                <div class="image img-cir img-40">
                                                    <img src="BootstrapTemplate/images/icon/avatar-06.jpg" alt="Cynthia Harvey" />
                                                </div>
                                                <div class="content">
                                            ...
                                            <div class="email__item">
                                                <div class="image img-cir img-40">
                                                    <img src="BootstrapTemplate/images/icon/avatar-05.jpg" alt="Cynthia Harvey" />
                                                </div>
                                                <div class="content">
                                                    <p>Meeting about new dashboard...</p>
                                            ...
                                            <div class="email__item">
                                                <div class="image img-cir img-40">
                                                    <img src="BootstrapTemplate/images/icon/avatar-04.jpg" alt="Cynthia Harvey" />
                                                </div>
                                                <div class="content">
                                                    <p>Meeting about new dashboard...</p>
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            <img src="BootstrapTemplate/images/icon/avatar-01.jpg" alt="John Doe" />
                                        </div>
                                        <div class="content">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
                                    <div class="au-card-title" style="background-image:url('BootstrapTemplate/images/bg-title-01.jpg');">
                            ...
                            <div class="col-lg-6">
                                <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
                                    <div class="au-card-title" style="background-image:url('BootstrapTemplate/images/bg-title-02.jpg');">
                                        <div class="bg-overlay bg-overlay--blue"></div>
                                        <h3>
                                                    ...
                                                    <div class="au-message__item-inner">
                                                        <div class="au-message__item-text">
                                                            <div class="avatar-wrap">
                                                                <div class="avatar">
                                                                    <img src="BootstrapTemplate/images/icon/avatar-02.jpg" alt="John Smith">
                                                                </div>
                                                            </div>
                                                            <div class="text">
                                                    ...
                                                    <div class="au-message__item-inner">
                                                        <div class="au-message__item-text">
                                                            <div class="avatar-wrap online">
                                                                <div class="avatar">
                                                                    <img src="BootstrapTemplate/images/icon/avatar-03.jpg" alt="Nicholas Martinez">
                                                                </div>
                                                            </div>
                                                            <div class="text">
                                                ...
                                                <div class="au-message__item">
                                                    <div class="au-message__item-inner">
                                                        <div class="au-message__item-text">
                                                            <div class="avatar-wrap online">
                                                                <div class="avatar">
                                                                    <img src="BootstrapTemplate/images/icon/avatar-04.jpg" alt="Michelle Sims">
                                                                </div>
                                                            </div>
                                                            <div class="text">
                                                ...
                                                <div class="au-message__item">
                                                    <div class="au-message__item-inner">
                                                        <div class="au-message__item-text">
                                                            <div class="avatar-wrap">
                                                                <div class="avatar">
                                                                    <img src="BootstrapTemplate/images/icon/avatar-05.jpg" alt="Michelle Sims">
                                                                </div>
                                                            </div>
                                                            <div class="text">
                                                                <h5 class="name">Michelle Sims</h5>
